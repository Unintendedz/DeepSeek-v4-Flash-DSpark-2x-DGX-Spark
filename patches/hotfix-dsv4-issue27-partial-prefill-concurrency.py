...
``max_num_batched_tokens`` leaving room for decode tokens). This profile keeps
the explicit compose/production cap at 2, allowing two overlapping prefills
while the issue #43 floor preserves decode budget.
